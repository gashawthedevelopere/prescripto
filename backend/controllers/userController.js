...
const paymentStripe = async (req, res) => {
    try {
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            success_url: `${origin}/my-appointments?success=true&appointmentId=${appointmentData._id}`, // Success redirect URL
            cancel_url: `${origin}/doctors?success=false&appointmentId=${appointmentData._id}`, // Cancel redirect URL
            mode: 'payment',
        });
...
//     try {
//         const { userId } = req.body;
//         const userData = await userModel.findById(userId).select('-password'); // Skip password field in response
